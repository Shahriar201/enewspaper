                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a class="btn btn-success float-right btn-sm" href="{{ route('menues.view') }}">
                                    <i class="fa fa-list"></i>Menu List</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                ...
                                {{-- User add form --}}
                                <form method="post"
                                    action="{{ @$editData ? route('menues.update', $editData->id) : route('menues.store') }}"
