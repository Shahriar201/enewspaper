                                    ...
                                    <div class="tab-image tab-border">
                                        <a href="{{ route('single.post', $last_post->id) }}">
                                            <img class="lazyload" {{-- src="{{ asset('public/frontend') }}/templateimage/60e42594dd1aa.jpg" --}}
                                                ...
                                                {{-- alt="{!! $last_post->title !!}" title="{!! $last_post->title !!}" --}} /></a>
                                    ...
                                    <div class="tab-image tab-border">
                                        <a href="{{ route('single.post', $popular_post->id) }}">
                                            <img class="lazyload" {{-- src="{{ asset('public/frontend') }}/templateimage/60e42594dd1aa.jpg" --}}
                                                ...
                                                {{-- alt="{!! $popular_post->title !!}" title="{!! $popular_post->title !!}" --}} /></a>


                                        <h4 class="tab_hadding"><a
                                                href="{{ route('single.post', $popular_post->id) }}">
                                                {!! $popular_post->title !!}
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <div class="white-bg">
                        ...
                        @foreach ($international_posts as $international_sub_post)
                            <div class="secFour-smallItem">
                                <div class="secFour-smallImg">
                                    <a href="{{ route('single.post', $international_sub_post->id) }}">
                                        <img class="lazyload" {{-- src="{{ asset('public/frontend') }}/templateimage/60e42594dd1aa.jpg" --}}
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <div class="white-bg">
                        @foreach ($politics as $politic)
                            <div class="secFour-image">
                                <a href="{{ route('single.post', $politic->id) }}">
                                    <img class="lazyload" {{-- src="{{ asset('public/frontend') }}/templateimage/60e42594dd1aa.jpg" --}}
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        @php
                            $all_countries = App\Model\Post::where('status', 0)
                                ->where('menu_id', 5)
                                ->orderBy('id', 'DESC')
                                ->get();
                        @endphp
                                ...
                                @foreach ($all_countries as $country)
                                    <div class="sec-two-wrpp">
                                        <div class="section-two-image">
                                            <a href="{{ route('single.post', $country->id) }}">
                                                <img class="lazyload"
                                                    src="{{ asset('public/upload/post_images/' . $country->image) }}"
                                                    {{-- data-src="https://themebazar.xyz/laraflash/public/postimages/609d3c5a6ebf5.png" --}} alt="{!! $country->title !!}"
                                                    title="{!! $country->title !!}" />
                                            </a>
                        ...
                        <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                            ...
                            @php
                                $economics = App\Model\Post::where('status', 0)
                                    ->where('menu_id', 4)
                                    ->orderBy('id', 'DESC')
                                    ->get();
                            @endphp
                            ...
                            <div class="sec-tow-content">
                                @foreach ($economics as $economy)

                                    <div class="sec-two-wrpp">
                                        <div class="section-two-image">
                                            <a href="{{ route('single.post', $economy->id) }}">
                                                <img class="lazyload"
                                                    src="{{ asset('public/upload/post_images/' . $economy->image) }}"
                                                    {{-- data-src="https://themebazar.xyz/laraflash/public/postimages/608a8b6433ea0.png" --}} alt="{!! $economy->title !!}"
                                                    title="{!! $economy->title !!}" />
                                            </a>
                        ...
                        <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                            ...
                            @php
                                $sports = App\Model\Post::where('status', 0)
                                    ->where('menu_id', 6)
                                    ->orderBy('id', 'DESC')
                                    ->get();
                            @endphp
                            ...
                            <div class="sec-tow-content">
                                @foreach ($sports as $sport)
                                    <div class="sec-two-wrpp">
                                        <div class="section-two-image">
                                            <a href="{{ route('single.post', $sport->id) }}">
                                                <img class="lazyload"
                                                    src="{{ url('public/upload/post_images/' . $sport->image) }}"
                                                    {{-- data-src="https://themebazar.xyz/laraflash/public/postimages/608aa5be4c593.png" --}} alt="{!! $sport->title !!}"
                                                    title="{!! $sport->title !!}" />
                                            </a>
                        ...
                        <div class="tab-pane fade" id="pills-item" role="tabpanel" aria-labelledby="pills-item-tab">
                            @php
                                $entertains = App\Model\Post::where('status', 0)
                                    ->where('menu_id', 7)
                                    ->orderBy('id', 'DESC')
                                    ->get();
                            @endphp
                            ...
                            <div class="sec-tow-content">
                                @foreach ($entertains as $entertain)
                                    <div class="sec-two-wrpp">
                                        <div class="section-two-image">
                                            <a
                                                href="{{ route('single.post', $entertain->id) }}">
                                                <img class="lazyload"
                                                    src="{{ url('public/upload/post_images/' .$entertain->image) }}"
                        ...
                        <div class="tab-pane fade" id="pills-item22" role="tabpanel" aria-labelledby="pills-item-tab22">
                            ...
                            @php
                                $aros = App\Model\Post::where('status', 0)
                                    ->where('menu_id', 8)
                                    ->orderBy('id', 'DESC')
                                    ->get();
                            @endphp
                            ...
                            <div class="sec-tow-content">
                                @foreach ($aros as $aro)
                                    <div class="sec-two-wrpp">
                                        <div class="section-two-image">
                                            <a
                                                href="{{ route('single.post', $aro->id) }}">
                                                <img class="lazyload"
                                                    src="{{ url('public/upload/post_images/' .$aro->image) }}"
                            ...
                            @foreach ($all_countries as $country)
                                <div class="secThree-bg">
                                    ...
                                    <div class="sec-theee-image">
                                        <a {{-- href="{{ route('single.post', $politic_sub->title) }}"> --}} <img class="lazyload" {{-- src="{{ url('public/upload/post_images/' .$all_post->image) }}" --}}
