                        ...
                        <div class="tab-pane fade" id="pills-item" role="tabpanel" aria-labelledby="pills-item-tab">
                            ...
                            <div class="sec-tow-content">
                                @foreach ($entertains as $entertain)
                                    <div class="sec-two-wrpp">
                                        <div class="section-two-image">
                                            <a href="{{ route('single.post', $entertain->id) }}">
                                                <img class="lazyload"
                                                    src="{{ url('public/upload/post_images/' . $entertain->image) }}"
                                                    {{-- data-src="https://themebazar.xyz/laraflash/public/postimages/60a399b07cc9d.jpg" --}} alt="{!! $entertain->title !!}"
                        ...
                        <div class="tab-pane fade" id="pills-item22" role="tabpanel" aria-labelledby="pills-item-tab22">
                            ...
                            <div class="sec-tow-content">
                                @foreach ($aros as $aro)
                                    <div class="sec-two-wrpp">
                                        <div class="section-two-image">
                                            <a href="{{ route('single.post', $aro->id) }}">
                                                <img class="lazyload"
                                                    src="{{ url('public/upload/post_images/' . $aro->image) }}"
                                                    {{-- data-src="https://themebazar.xyz/laraflash/public/postimages/608aa61f7f2e8.png" --}} alt="{!! $aro->title !!}"
                                                    title="{!! $aro->title !!}" />
                                            </a>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="secThree-bg">
                                ...
                                @foreach ($all_countries as $country)
                                    ...
                                    <div class="sec-theee-image">
                                        <a href="{{ route('single.post', $country->id) }}"> <img class="lazyload"
                                                src="{{ url('public/upload/post_images/' . $country->image) }}"
                                                {{-- data-src="https://themebazar.xyz/laraflash/public/postimages/609d3c5a6ebf5.png" --}} alt="{!! $country->title !!}"
                                                title="{!! $country->title !!}" />
                                        </a>
                            ...
                            <div class="secThree-content">
                                @php
                                    $country = App\Model\Post::where('status', 0)
                                        ->where('menu_id', 5)
                                        ->inRandomOrder()
                                        ->limit(2)
                                        ->get();
                                ...
                                @foreach ($country as $c)
                                    <div class="secThree-wrpp">
                                        <div class="secThree-bg">
                                            <div class="sec-theee-image">
                                                <a href="{{ route('single.post', $c->id) }}">
                                                    <img class="lazyload"
                                                        src="{{ url('public/upload/post_images/' . $c->image) }}"
                                                        {{-- data-src="https://themebazar.xyz/laraflash/public/postimages/609d3bd9de732.png" --}} alt="{!! $c->title !!}’"
                                                        title="{!! $c->title !!}’" />
                                                </a>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="bg2">
                                ...
                                @php
                                    $countries_sub = App\Model\Post::where('status', 0)
                                        ->where('menu_id', 5)
                                        ->inRandomOrder()
                                        ->limit(5)
                                        ->get();
                                @endphp
                                @foreach ($countries_sub as $country)
                                    <div class="secThree-smallItem">
                                        <div class="secThree-smallImg">
                                            <a href="{{ route('single.post', $country->id) }}">
                                                <img class="lazyload"
                                                    src="{{ url('public/upload/post_images/' . $country->image) }}"
                                                    {{-- data-src="https://themebazar.xyz/laraflash/public/postimages/609d3b135e729.png" --}} alt="{!! $country->title !!}"
                                                    title="{!! $country->title !!}" />
                                            </a>
                                            ...
                                            <h5 class="secThree_mallTitle">
                                                <a href="{{ route('single.post', $country) }}">
                                                    {!! $country->title !!}
                                                </a>
                                            </h5>
                                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    @php
                        $ict = App\Model\Post::where('status', 0)
                            ->where('menu_id', 10)
                            ->orderBy('id', 'DESC')
                            ->get();
                    @endphp
                        ...
                        @foreach ($ict as $i)
                            <div class="secFive-wrpp2 bg-3">
                                <div class="secFive-image2">
                                    <a
                                        href="{{ route('single.post', $i->id) }}">
                                        <img class="lazyload"
                                            src="{{ url('public/upload/post_images/' .$i->image) }}"
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7">
                    <div class="secFive-content">
                        @php
                            $travelling_sub = App\Model\Post::where('status', 0)
                                ->where('menu_id', 11)
                                ->orderBy('id', 'DESC')
                                ->inRandomOrder()
                                ->limit(6)
                                ->get()
                        @endphp
                        @foreach ($travelling_sub as $travel_sub)
                            <div class="secFive-wrpp bg-3">
                                <div class="secFive-image2">
                                    <a
                                        href="{{ route('single.post', $travel_sub->id) }}">
                                        <img class="lazyload"
                                            src="{{ url('public/upload/post_images/' .$travel_sub->image) }}"
                                            {{-- data-src="https://themebazar.xyz/laraflash/public/postimages/608ab4c6813b6.png" --}}
                                            alt="{!! $travel_sub->title !!}"
                                            title="{!! $travel_sub->title !!}" />
                                    </a>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    ...
                    <div class="white-bg">
                        <div class="main-part">
                            @php
                                $religion = App\Model\Post::where('status', 0)
                                    ->where('menu_id', 12)
                                    ->orderBy('id', 'DESC')
                                    ->limit(1)
                                    ->get()
                            ...
                            @foreach ($religion as $rel)
                                <div class="secFour-image">
                                    ...
                                    <a
                                        href="{{ route('single.post', $rel->id) }}">
                                        <img class="lazyload"
                                            src="{{ url('public/upload/post_images/' .$rel->image) }}"
                        ...
                        @php
                            $religion_sub = App\Model\Post::where('status', 0)
                                ->where('menu_id', 12)
                                ->orderBy('id', 'DESC')
                                ->inRandomOrder()
                                ->limit(3)
                        ...
                        @foreach ($religion_sub as $rel_sub)
                            <div class="secFour-smallItem">
                                <div class="secFour-smallImg">
                                    <a
                                        href="{{ route('single.post', $rel_sub->id) }}">
                                        <img class="lazyload"
                                            src="{{ url('public/upload/post_images/' .$rel_sub->image) }}"
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <div class="white-bg">
                        <div class="education-main">
                            @php
                                $educations = App\Model\Post::where('status', 0)
                                    ->where('menu_id', 13)
                                    ->orderBy('id', 'DESC')
                                    ->limit(1)
                                    ->get()
                            ...
                            @foreach ($educations as $education)
                                <div class="secFour-image">
                                    <a
                                        href="{{ route('single.post', $education->id) }}">
                                        <img class="lazyload"
                                            src="{{ url('public/upload/post_images/' .$education->image) }}"
                        ...
                        @php
                            $educations = App\Model\Post::where('status', 0)
                                ...
                                ->get()
                        @endphp
                        @foreach ($educations as $education_sub)
                            <div class="secFour-smallItem">
                                <div class="secFour-smallImg">
                                    <a
                                        href="{{ route('single.post', $education_sub->id) }}">
                                        <img class="lazyload"
                                            src="{{ url('public/upload/post_images/' .$education_sub->image) }}"
                                            {{-- data-src="https://themebazar.xyz/laraflash/public/postimages/608ac03ece89c.png" --}}
                                            alt="{!! $education_sub->title !!}"
                                            title="{!! $education_sub->title !!}" />
                                    </a>
