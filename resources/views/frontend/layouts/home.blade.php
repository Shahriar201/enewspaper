        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    @php
                        $international_posts = App\Model\Post::where('status', 0)
                            // ->with(['menu'])
                            ->where('menu_id', '2')
                            ->orderBy('id', 'DESC')
                            ->limit(1)
                    ...
                    <div class="white-bg">
                        ...
                        @foreach ($international_posts as $international_sub_post)
                        <div class="secFour-smallItem">
                            <div class="secFour-smallImg">
                                <a
                                    href="">
                                    <img class="lazyload"
                                        ...
                                        {{-- alt="{!! $international_sub_post->title !!}"
                                        title="{!! $international_sub_post->title !!}"  --}}
                                        />
                                </a>
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    @php
                        $politics = App\Model\Post::where('status', 0)
                                    ->where('menu_id', 3)
                                    ->orderBy('id', 'DESC')
                                    ->limit(1)
                                    ->get();
                    ...
                    <div class="white-bg">
                        ...
                        @foreach ($politics as $politic_sub)
                        <div class="secFour-smallItem">
                            <div class="secFour-smallImg">
                                <a
                                    href="">
                                    <img class="lazyload"
                                        ...
                                        {{-- alt="{!! $politic_sub->title !!}"
                                        title="{!! $politic_sub->title !!}" --}}
                                         />
                                </a>
                                <a href=""
