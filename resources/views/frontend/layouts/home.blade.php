                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="news-titletab">
                                ...
                                @php
                                    $last_posts = App\Model\Post::where('status', 0)
                                                ->orderBy('id', 'DESC')
                                                ->limit(20)
                                                ->get();
                                @endphp
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    ...
                    @php
                        $national_posts = App\Model\Post::where('status', 0)
                            // ->with(['menu'])
                            ->where('menu_id', '1')
                            ->orderBy('id', 'DESC')
                            ->limit(1)
                    ...
                    <div class="white-bg">
                        ...
                        @php
                            $national_sub_posts = App\Model\Post::where('status', 0)
                                // ->with(['menu'])
                                ->where('menu_id', '1')
                                ->inRandomOrder()
                                ->limit(3)
                            ...
                            <div class="secFour-smallImg">
                                <a
                                    ...
                                    <img class="lazyload"
                                        ...
                                        alt="{{ $national_sub_post->title }}"
                                        title="{{ $national_sub_post->title }}" />
                                </a>
